...
?>
<h3 class="pk-astrology-text-center pk-astrology-pad-xsmall"><?php echo $translation_data['aspect_chart']; // phpcs:ignore WordPress.Security.EscapeOutput ?></h3>
<div class="pk-astrology-aspect-chart">
