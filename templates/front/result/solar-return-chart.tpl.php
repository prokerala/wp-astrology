		...
		<?php if (null !== $result): ?>
			...
			<table class="table table-bordered mt-5 mb-5">
				<tr>
					...
					<td><?=$result->getSolarDatetime()->format('d M Y, h:i A')?></td>
				</tr>
			</table>
...
<!--				   Planet Position table  -->
			<table class="table table-bordered">
				...
				<?php foreach($result->getSolarDetails()->getPlanetPositions() as $planetPosition): ?>
					<tr>
			...
			<table class="table table-bordered">
				...
				<?php foreach($result->getSolarDetails()->getAngles() as $planetPosition): ?>
					<tr>
						<td><?=$planetPosition->getName()?></td>
						<td><?=round($planetPosition->getLongitude(), 2)?></td>
						<td><?=round($planetPosition->getDegree(), 2)?></td>
			...
			<h3 class="text-center mt-5">Solar - Natal Aspects</h3>
			<table class="table table-bordered">
				<tr>
					<th>Planet 1</th>
					<th>Aspect</th>
