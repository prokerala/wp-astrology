...
<?php else : ?>
	<div class="pk-astrology-form-group pk-astrology-row">
		<label class="pk-astrology-col-sm-3 pk-astrology-col-md-4 pk-astrology-form-label"><?= $translation_data['result_type']?>: </label>
		<div class="pk-astrology-col-sm-9 pk-astrology-col-md-6 ">
			<div class="pk-astrology-form-check-inline">
				...
				<label class="pk-astrology-form-check-label" for="result_type1"><?= $translation_data['basic']?></label>
			</div>
			<div class="pk-astrology-form-check-inline">
				...
				<label class="pk-astrology-form-check-label" for="result_type2"><?= $translation_data['advanced']?></label>
			</div>
		</div>
	</div>
<?php endif; ?>
